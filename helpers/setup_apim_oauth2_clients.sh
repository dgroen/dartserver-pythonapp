...
echo ""
echo "  1. Open WSO2 IS myaccount portal: https://$IS_HOST:$IS_PORT/myaccount"
echo "  2. Login with credentials:"
echo "     Username: $IS_ADMIN_USER"
echo "     Password: $IS_ADMIN_PASSWORD"
echo ""
echo "  3. Navigate to: Security → OAuth Applications"
echo ""
echo "  4. Click 'Register' and fill in:"
echo ""
echo "     Application Name: APIM"
echo ""
echo "     Authorized Redirect URIs (add all):"
...
echo "       • Implicit"
echo ""
echo "  5. Complete registration and copy the credentials:"
echo "     • Client ID"
echo "     • Client Secret"
echo ""
echo "  6. Update /wso2apim-4-config/deployment.toml [oauth2.oidc] section:"
echo ""
cat << 'TOML'
[oauth2.oidc]
