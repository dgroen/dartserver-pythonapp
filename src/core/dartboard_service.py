...
from .database_models import DartboardType, DartboardZoneMapping
...
class DartboardService:
    ...
    def get_zone_from_pins(
        ...
        return {
            ...
            "score": DartboardService.calculate_score(mapping.base_value, mapping.multiplier_type),  # type: ignore
        }
