...
class RabbitMQConsumer:
    ...
    def connect(self):
        ...
        print(
            f"Listening on exchange '{self.config['exchange']}' "
            f"with topic '{self.config['topic']}'",
        )
    ...
    def start(self):
        ...
        while not self.should_stop:
            try:
                ...
                # Start consuming
                self.channel.basic_consume(  # type: ignore[union-attr]
                    queue=queue_name,
