...
class TestTTSService:
    ...
    @patch("dartserver_services.tts_service.GTTS_AVAILABLE", True)
    ...
    @patch("dartserver_services.tts_service.PYTTSX3_AVAILABLE", True)
    @patch("dartserver_services.tts_service.pyttsx3")
    ...
    @patch("dartserver_services.tts_service.GTTS_AVAILABLE", False)
    @patch("dartserver_services.tts_service.PYTTSX3_AVAILABLE", False)
    ...
    def test_enable_disable(self):
        ...
        with patch("dartserver_services.tts_service.GTTS_AVAILABLE", True):
            tts = TTSService(engine="gtts")
            assert tts.enabled is True
    ...
    @patch("dartserver_services.tts_service.GTTS_AVAILABLE", True)
    @patch("dartserver_services.tts_service.gTTS")
    def test_speak_gtts_generate_audio(self, mock_gtts):
        ...
        with patch("dartserver_services.tts_service.io.BytesIO", return_value=mock_audio_fp):
