...
Save the PRD into `/data/dartserver-pythonapp/.zencoder/chats/2e24bead-908c-4c72-a98b-f7001c582fd5/requirements.md`.

### [ ] Step: Technical Specification

Based on the PRD in `/data/dartserver-pythonapp/.zencoder/chats/2e24bead-908c-4c72-a98b-f7001c582fd5/requirements.md`, create a detailed technical specification to be used by a coding agent to implement the feature. Follow this template:
...
Save the spec to `/data/dartserver-pythonapp/.zencoder/chats/2e24bead-908c-4c72-a98b-f7001c582fd5/spec.md`.

### [ ] Step: Implementation Plan

Based on the technical spec in `/data/dartserver-pythonapp/.zencoder/chats/2e24bead-908c-4c72-a98b-f7001c582fd5/spec.md`, create a detailed task plan and update `/data/dartserver-pythonapp/.zencoder/chats/2e24bead-908c-4c72-a98b-f7001c582fd5/plan.md`. Each task should have task definition, references to contracts to be used/implemented, deliverable definition and verification instructions.
